      ...
      <div className="flex flex-col w-1/4 h-full">
        ...
        <div className="bg-white flex-grow p-4 flex flex-col items-start">
          ...
          <Link
            ...
            className={`flex items-center w-full px-4 py-3 mb-2 text-black hover:bg-gray-200 rounded ${
              window.location.pathname === '/student-dashboard' ? 'bg-gray-300 font-bold' : ''
            }`}
          >
          ...
          <Link
            to="/student-courses"
            className={`flex items-center w-full px-4 py-3 mb-2 text-black hover:bg-gray-200 rounded ${
              window.location.pathname === '/student-courses' ? 'bg-gray-300 font-bold' : ''
            }`}
          >
            <FaBook className="mr-2" /> My Bootcamps
          </Link>
        </div>
      </div>
      ...
      <div className="w-3/4 bg-blue-50 p-8 h-full">
        ...
        <div className="bg-white p-6 rounded shadow-md">
          ...
          <div className="space-y-4">
            <p className="text-lg">
              <strong className="block text-gray-700">Access your enrolled courses and manage your learning here.</strong>
            </p>
          </div>
        </div>
      </div>
