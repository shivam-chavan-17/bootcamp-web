...
const Homepage = () => {
    return (
        <div>
            <Navbar />
            {/* Header Section */}
            <header className="relative bg-black h-auto min-h-[50vh] md:min-h-[60vh] flex flex-col items-center py-6">
                <div className="container mx-auto flex flex-col md:flex-row items-center justify-around h-full px-8">
                    {/* Left side: Text */}
                    ...
                    <div className="hidden md:block md:w-1/2 ml-16 flex justify-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div key={i} className="p-6 bg-gray-100 rounded shadow-lg flex items-start">
                                <div className="bg-black text-white w-12 h-12 rounded-full flex items-center justify-center font-bold text-xl mr-4">{i}</div>
                                <div>
            ...
            {/* About Section */}
            <section className="container mx-auto py-10 md:py-16 flex flex-col md:flex-row items-center">
                {/* About Image */}
                <div className="w-full md:w-1/2 flex justify-center mb-6 md:mb-0"> {/* Flex and justify-center for proper centering */}
            ...
            <section className="bg-white py-10 md:py-16">
                <div className="container mx-auto">
                    ...
                    <div className="text-center mt-12">
                        <button className="bg-black text-white px-6 py-3 rounded hover:bg-blue-600 transition">Explore More</button>
                    </div>
                </div>
            </section>
            <Footer />
